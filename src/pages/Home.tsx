    ...
    <div className="bg-light">
      ...
      <section className="py-16 md:py-20 bg-light border-y border-primary/10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-silver text-base max-w-3xl mx-auto">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              ...
              <div className="bg-white border border-primary/20 p-8">
                <p className="text-primary font-semibold text-base">
                  Alinhamento entre direção e execução
                </p>
              </div>
              <div className="bg-white border border-primary/20 p-8">
                <p className="text-primary font-semibold text-base">
      ...
      <section className="py-20 md:py-32 bg-light">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-primary/85 leading-relaxed">
              <p>
